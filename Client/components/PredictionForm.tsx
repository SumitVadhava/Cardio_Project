...
// Custom Switch Component using Headless UI
        ...
        >
          <div className="flex items-center justify-between gap-3">
            <div className="flex-1">
              <Switch.Label className="text-sm font-medium text-slate-200 cursor-pointer">
                {label}
              </Switch.Label>
              {description && (
                <Switch.Description className="text-xs text-slate-500 mt-0.5">
                  {description}
                </Switch.Description>
              )}
            </div>
