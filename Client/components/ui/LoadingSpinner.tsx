...
export function SkeletonCard() {
  return (
    <div className="p-4 bg-background-card rounded-xl border border-border/50 animate-pulse">
...
export function ProgressBar({
  ...
  const colors = {
    ...
    success: 'bg-gradient-to-r from-risk-low to-success',
    warning: 'bg-gradient-to-r from-risk-medium to-warning',
    danger: 'bg-gradient-to-r from-risk-high to-error',
  };
