...
export default function DashboardPage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-8 text-lg">
      {/* Hero Header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent/20 via-background-card to-primary-light/10 border border-slate-700/50 p-6 md:p-8">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-text-muted max-w-xl text-xl mx-auto">
      ...
      {/* Stats Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 justify-items-center text-center">
        {stats.map((stat) => (
          <StatsCard
            key={stat.name}
            title={stat.name}
