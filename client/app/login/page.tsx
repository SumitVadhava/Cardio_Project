...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-pink-100 to-transparent rounded-full blur-3xl translate-x-1/2 translate-y-1/2" />
      
      <Card className="w-full max-w-md relative z-10 glass">
        {/* Logo Section */}
        <div className="text-center mb-8">
          <div className="relative inline-block">
            <div className="absolute inset-0 bg-gradient-to-br from-accent to-primary-light rounded-2xl blur-xl opacity-30 animate-pulse-glow" />
            <div className="relative p-4 bg-gradient-to-br from-accent to-primary-light rounded-2xl shadow-lg">
